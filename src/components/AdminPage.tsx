        ...
        <div style={S.page}>
            <div style={S.header}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
                    <span style={{ fontSize: 13, opacity: 0.7 }}>Администратор</span>
            ...
            <div style={S.content}>
                ...
                {activeTab === 'users' && (
                    <div style={S.card}>
                        ...
                        <div style={{ overflowX: 'auto' }}>
                            <table style={S.table}>
                                <thead><tr><th style={S.th}>ID</th><th style={S.th}>Имя</th><th style={S.th}>Email</th><th style={S.th}>Телефон</th><th style={S.th}>Действия</th></tr></thead>
                                <tbody>
                                    {users.map(u => (
                                        <tr key={u.id}>
                                            ...
                                            <td style={S.td}><button style={S.deleteBtn} onClick={() => handleDelete(u.id, deleteUser)}>Удалить</button></td>
                                        </tr>
                                    ))}
                ...
                {activeTab === 'drivers' && (
                    <div style={S.card}>
                        <div style={S.cardHeader}><h2 style={S.cardTitle}>Водители</h2><button style={S.addBtn} onClick={() => openCreate('driver')}>+ Добавить</button></div>
                        <div style={S.filterRow}>
                        ...
                        <div style={{ overflowX: 'auto' }}>
                            <table style={S.table}>
                                <thead><tr><th style={S.th}>ID</th><th style={S.th}>Имя</th><th style={S.th}>Паспорт</th><th style={S.th}>Возраст</th><th style={S.th}>Ставка</th><th style={S.th}>Категория</th><th style={S.th}>Действия</th></tr></thead>
                                <tbody>
                                    {drivers.map(d => (
                                        <tr key={d.id}>
                                            ...
                                            <td style={S.td}><button style={S.editBtn} onClick={() => openEdit('driver', { ...d, licenceCategories: d.licenceCategories?.name })}>Ред.</button><button style={S.deleteBtn} onClick={() => handleDelete(d.id, deleteDriver)}>Удалить</button></td>
                                        </tr>
                                    ))}
                ...
                {activeTab === 'cars' && (
                    <div style={S.card}>
                        <div style={S.cardHeader}><h2 style={S.cardTitle}>Машины</h2><button style={S.addBtn} onClick={() => openCreate('car')}>+ Добавить</button></div>
                        <div style={S.filterRow}>
                        ...
                        <div style={{ overflowX: 'auto' }}>
                            <table style={S.table}>
                                <thead><tr><th style={S.th}>ID</th><th style={S.th}>Марка / Модель</th><th style={S.th}>Тип</th><th style={S.th}>Госномер</th><th style={S.th}>Груз. (т)</th><th style={S.th}>Объём (м³)</th><th style={S.th}>Расход</th><th style={S.th}>Кат.</th><th style={S.th}>Действия</th></tr></thead>
                                <tbody>
                                    {cars.map(c => (
                                        <tr key={c.id}>
                                            ...
                                            <td style={S.td}><button style={S.editBtn} onClick={() => openEdit('car', { ...c, licenceCategories: c.licenceCategories?.name })}>Ред.</button><button style={S.deleteBtn} onClick={() => handleDelete(c.id, deleteCar)}>Удалить</button></td>
                                        </tr>
                                    ))}
                ...
                {activeTab === 'loaders' && (
                    <div style={S.card}>
                        <div style={S.cardHeader}><h2 style={S.cardTitle}>Грузчики</h2><button style={S.addBtn} onClick={() => openCreate('loader')}>+ Добавить</button></div>
                        <div style={S.filterRow}>
                        ...
                        <div style={{ overflowX: 'auto' }}>
                            <table style={S.table}>
                                <thead><tr><th style={S.th}>ID</th><th style={S.th}>Имя</th><th style={S.th}>Паспорт</th><th style={S.th}>Возраст</th><th style={S.th}>Действия</th></tr></thead>
                                <tbody>
                                    {loaders.map(l => (
                                        <tr key={l.id}>
                                            ...
                                            <td style={S.td}><button style={S.editBtn} onClick={() => openEdit('loader', l)}>Ред.</button><button style={S.deleteBtn} onClick={() => handleDelete(l.id, deleteLoader)}>Удалить</button></td>
                                        </tr>
                                    ))}
                ...
                {activeTab === 'licenceCategories' && (
                    <div style={S.card}>
                        <div style={S.cardHeader}><h2 style={S.cardTitle}>Категории прав</h2><button style={S.addBtn} onClick={() => openCreate('licence')}>+ Добавить</button></div>
                        <div style={S.filterRow}>
                        ...
                        <div style={{ overflowX: 'auto' }}>
                            <table style={S.table}>
                                <thead><tr><th style={S.th}>ID</th><th style={S.th}>Категория</th><th style={S.th}>Действия</th></tr></thead>
                                <tbody>
                                    {licenceCategories.map(lc => (
                                        <tr key={lc.id}>
                                            ...
                                            <td style={S.td}><button style={S.editBtn} onClick={() => openEdit('licence', lc)}>Ред.</button><button style={S.deleteBtn} onClick={() => handleDelete(lc.id, deleteLicenceCategory)}>Удалить</button></td>
                                        </tr>
                                    ))}
